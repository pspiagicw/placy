...
const OtpInput = ({ code, setCode, maximumLength, setIsPinReady }) => {
    ...
    const boxDigit = (_, index) => {
        ...
        const SplitBoxes = ({ children }) => <View style={{ borderColor: colors.secondary, borderWidth: 1, borderRadius: 50, padding: 9, width: 50, height: 50, marginHorizontal:5 }}>{children}</View>
